...
class TrackingForm(Form):
    exclude = BooleanField(u"Not trackable",[validators.DataRequired()], default=False)
    relative_area_threshold = FloatField(u"Threshold for relative area",
                                         [validators.DataRequired()], default=0.01)
    ratio_threshold = FloatField(u"Threshold for major/minor radius ratio threshold",
                                 [validators.DataRequired()], default=1.5)
    ...
    margin = FloatField(u"Minimal side margin", [validators.DataRequired()],
                        default=0.02)
